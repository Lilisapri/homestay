        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="control-label">Date to Check In</label>
                    <input type="date" class='form form-control' required   name='date_in'>
                </div>
                <div class="form-group">
                    <label for="control-label">Date to Check Out</label>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>Additional Accommodation <input type="hidden" name="accommodation_sub" value="0"></td>
...
<script>
    ...
    $(function(){
        ...
        $('#book-form').submit(function(e){
            ...
            start_loader()
            $.ajax({
                url:_base_url_+"classes/Master.php?f=book_form",
                method:"POST",
                data:$(this).serialize(),
                dataType:"json",
                error:err=>{
